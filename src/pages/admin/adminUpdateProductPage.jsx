//addProduct page eka wgemai, ee form ekma use krnwa...Update form ekta awama adala item eke danata thiyena values form eke show krnn one
...
export default function AdminUpdateProductPage() {
    ...
    const [isAvailability, setIsAvailability] = useState(location.state.isAvailability);
    ...
    async function updateProduct() {
       ...
       //"images" kiyna promises dala thiyna array ek
    ...
    return(
        <div className="w-full h-full flex justify-center p-[50px] items-start overflow-y-scroll ">   
            <div className="w-[800px] p-[30px] bg-accent/75 rounded-2xl shadow-2xl overflow-y-visible">
                <h1 className="text-xl text-primary mb-[20px] text-center gap-[15px]"><FcAddDatabase className="inline mr-2" />Update Product</h1>
