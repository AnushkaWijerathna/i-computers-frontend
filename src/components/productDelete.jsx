  ...
  return (
    <>
      <button
        ...
        className="w-[70px] bg-[#CC2F0C] flex justify-center items-center text-white p-2 rounded-lg cursor-pointer hover:bg-[#A1230D] mt-1.5"
      >
        Delete
      </button>
        ...
        <div className="w-[100vw] h-screen fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          <div className="relative bg-primary w-[400px] h-[200px] rounded-2xl flex flex-col justify-center items-center p-6 shadow-2xl z-10">
            <button
              ...
              className="w-[40px] h-[40px] bg-red-700 rounded-full text-white text-2xl text-bold cursor-pointer hover:bg-red-950 absolute right-[-15px] top-[-15px]"
            >
              X
            </button>
